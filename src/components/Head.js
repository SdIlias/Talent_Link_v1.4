    ...
    return (
        <HeaderContainer>
            ...
            <NavLinks open={menuOpen}>
                ...
                <NavLink to="/studentprofile">Edit Profile</NavLink>
                <NavLink to="/studentjobs">Apply To Offers</NavLink>
                   <LogoutButtonInMenu>Logout</LogoutButtonInMenu>
            </NavLinks>
             <UserSection>
                 <Link to="/studentprofile"><UserAvatar src="../../images/profilepic.png" alt="User Avatar"/></Link>
...
const NavLinks = styled.nav`
  ...
  @media (max-width: 768px) {
       ...
       a {
            margin: 0.5rem 0;
            font-size: 16px;
             display: block;  /* Make the links fill the whole width */
        }
  }
`;
...
const UserAvatar = styled.img`
    width: 40px; /* Reduced user avatar width */
  height: 40px; /* Reduced user avatar height */
    border-radius: 50%;
  margin-right: 0.5rem;
      @media (max-width: 768px) {
